...
<!--<p>{{((prices.swapOut*decarbValue)/prices.glmr).toFixed(2)}} USD PRICE</p>-->
  ...
  methods: {
    ...
    if (id == 1) {
     ...
     this.tokensOptions = tokensFormat
      ...
      console.log(this.tokensOptions)
        let filteredTokens = []
    ...
    if (id == 2) {
        ...
        this.getSwapData()
      console.log('last step before swap')
    }
 },
    ...
    console.log('par ici',currentChainId.chainId, this.selectedChainOption )
      if (await currentChainId.chainId != this.selectedChainOption.chainId) {
          console.log('par la',currentChainId.chainId, this.selectedChainOption.chainId )
        try {
...
//this.currentPanel = 1
    ...
    async getSwapData() {
      try {
        ...
        //swapInfos.params.fromAmount = amount to send
